...
<div class="bikes">	
		 ...
		 <div class="bikes-grids">			 
			 <ul id="flexiselDemo1">
				 <li>
					 <img src="<?php bloginfo('template_directory');?>/images/bik1.jpg" alt=""/>
					 <div class="bike-info">
						 <div class="model">
				 ...
				 <li>
				 <img src="<?php bloginfo('template_directory');?>/images/bik2.jpg" alt=""/>
				 <div class="bike-info">
						 <div class="model">
				 ...
				 <li>
					 <img src="<?php bloginfo('template_directory');?>/images/bik3.jpg" alt=""/>
					 <div class="bike-info">
						 <div class="model">
				 ...
				 <li>
				     <img src="<?php bloginfo('template_directory');?>/images/bik4.jpg" alt=""/>
					 <div class="bike-info">
						 <div class="model">
				 ...
				 <li>
					 <img src="<?php bloginfo('template_directory');?>/images/bik5.jpg" alt=""/>
					 <div class="bike-info">
						 <div class="model">
				 ...
				 <li>
				      <img src="<?php bloginfo('template_directory');?>/images/bik6.jpg" alt=""/>
					  <div class="bike-info">
						 <div class="model">
							 <h4>SANSACHG<span>$249.00</span></h4>							 
						 </div>
